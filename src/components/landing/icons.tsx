...
/*
 * Package-manager logos, from simple-icons (CC0 1.0). Filled, not stroked, and
 * drawn in the current colour. The marks belong to their owners; they are here
 * to name the tools.
 */
function Brand({ size = 14, children, ...props }: IconProps & { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function NpmIcon(props: IconProps & { size?: number }) {
  return (
    <Brand {...props}>
...
export function PnpmIcon(props: IconProps & { size?: number }) {
  return (
    <Brand {...props}>
...
export function YarnIcon(props: IconProps & { size?: number }) {
  return (
    <Brand {...props}>
...
export function BunIcon(props: IconProps & { size?: number }) {
  return (
    <Brand {...props}>
